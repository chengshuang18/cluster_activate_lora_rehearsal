...
mkdir -p output/t5_large/cluster_activate/sequential/order_3/logs
bash scripts/t5_large/cluster_activate/order_3.sh 16 0 sequential True > output/t5_large/cluster_activate/sequential/order_3/logs/train_and_infer_0_True.log 2>&1


clusters=(32 16 64 1024)
ini_thresholds=(0.66 0.75 0.8)
cluster_constructure_methods=("weight_cluster")
